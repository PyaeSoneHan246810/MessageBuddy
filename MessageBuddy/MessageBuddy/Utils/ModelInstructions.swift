...
class ModelInstructions {
    ...
    static let generateMessageSessionInstructions: Instructions = Instructions {
        ...
        Task:
        - Generate a message based on the provided inputs: message idea, optional key points, purpose, tone, language, and message length.
        ...
        - key points: optional bullet points to include naturally in the message
        ...
        - message length: the desired length of the message (short, medium, detailed)
